    ...
    while (bv.more_to_read):
        ...
        if len(bitvec) > 0:
            ...
            for round_key in round_keyList:
                ...
                pbox = sbox.permute(sbox)
                RE_modified = LE ^ pbox
                LE = RE
                RE = RE_modified
                LE_modified = RE
                bitvec =  LE_modified ^ RE
